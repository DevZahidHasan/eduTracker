...
const sendDailyAttendanceReport = () => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendDailyAttendanceReport = sendDailyAttendanceReport;
const sendParentAttendanceNotification = (attendanceId) => __awaiter(void 0, void 0, void 0, function* () {
    const settings = yield prisma_1.default.systemSetting.findUnique({
...
exports.sendParentAttendanceNotification = sendParentAttendanceNotification;
const sendMarkFinalizationAlert = (className, subject, examType, lockedBy) => __awaiter(void 0, void 0, void 0, function* () {
    const settings = yield prisma_1.default.systemSetting.findUnique({
