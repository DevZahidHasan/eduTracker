...
const generateOrUpdateReport = (studentId, examType, teacherRemarks) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!aiInsights) {
        aiInsights = yield (0, ai_service_1.generatePerformanceInsights)(data.marks, []);
    }
    ...
    if (existingTermResult) {
        ...
        // Notify Parent
        const student = yield prisma_1.default.student.findUnique({ where: { id: studentId }, select: { parentId: true, fullName: true } });
        if (student === null || student === void 0 ? void 0 : student.parentId) {
