...
\restrict 18Zujyn0iKk81oKb3f9PI2O6LUPps0JyVow8uKH88BHxEWNbfPhHrfl1PLLSAji
...
SELECT pg_catalog.setval('public."AttendanceLock_id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Attendance_id_seq"', 169, true);
...
SELECT pg_catalog.setval('public."AuditLog_id_seq"', 86, true);
...
SELECT pg_catalog.setval('public."Mark_id_seq"', 14, true);
...
SELECT pg_catalog.setval('public."Notification_id_seq"', 28, true);
...
SELECT pg_catalog.setval('public."Student_id_seq"', 125, true);
...
\unrestrict 18Zujyn0iKk81oKb3f9PI2O6LUPps0JyVow8uKH88BHxEWNbfPhHrfl1PLLSAji
