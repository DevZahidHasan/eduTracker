...
export function QuestionPaperPreview({ data, schoolProfile }: QuestionPaperPreviewProps) {
  const {
    title,
    className,
    section,
  ...
  return (
    <div className="w-full h-full overflow-y-auto bg-slate-100 p-4 lg:p-8 flex justify-center print:bg-white print:p-0">
      <Card className="w-full max-w-[210mm] min-h-[297mm] bg-white shadow-xl mx-auto print:shadow-none print:max-w-none print:w-full">
        <CardContent className="p-8 lg:p-12 space-y-8 print:p-8">
          {/* Header */}
